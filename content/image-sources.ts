...
export const imageSources: ImageSource[] = [
  ...
  // --- IOWA (our own work) ---
  {
    ...
    alt: 'The Iowa website',
  },

  // --- VERMONT (our own work) ---
  {
    kind: 'own',
    ...
    alt: 'The Vermont website',
  },

  // --- MONTANA (our own work) ---
  {
    kind: 'own',
    ...
    alt: 'The Montana website',
  },

  // --- MELBOURNE (our own work) ---
  {
    kind: 'own',
  ...
  // --- BALI (our own work) ---
  {
    ...
    alt: 'The Bali website',
  },

  // --- NEW ZEALAND (our own work) ---
  {
    kind: 'own',
    ...
    alt: 'The New Zealand website',
  },

  // --- PALERMO (our own work) ---
  {
    kind: 'own',
  ...
  // --- HAWAII (our own work) ---
  {
    ...
    alt: 'The Hawaii website',
  },

  // --- WASHINGTON (our own work) ---
  {
    kind: 'own',
  ...
  // --- GALWAY (our own work) ---
  {
    ...
    alt: 'The Galway website',
  },

  // --- BELFAST (our own work) ---
  {
    kind: 'own',
